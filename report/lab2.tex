...
Vi valde att delvis följa rekommendationerna i labbpeket. Vi började med att implementera förgrundsprocesser med hjälp av |fork| och |execvp|. Det var lite problematiskt att implementera statistikutskrifter för dessa då tidtagning visade sig vara lite problematiskt.
Därefter la vi till inbyggda kommandon. Sedan la vi till bakgrundsprocesser som kontrolleras med pollning. Detta gick oväntat smidigt och fungerade i princip direkt. Det svåraste med bakgrundsprocesser visade sig vara att parsa |&|-symbolen.
